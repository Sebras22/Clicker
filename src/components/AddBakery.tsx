...
const AddBakery: React.FC<Bakeryprops> = ({ count, setCount, setPlusSecond, trucBakery, bakeries }) => {
  const bakeryPrice = bakeries.length * 150 + 130 * 4;
  ...
  return (
    <>
      {count < bakeryPrice ? (
        ...
        <Button
          onClick={() =>
            useAddBuilds('Bakery', bakeries, trucBakery, count, setCount, setPlusSecond, 110, 2)
          }
        >
